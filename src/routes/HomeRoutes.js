  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarLabel: t("homeRoutes.firstbarTitle"),
          tabBarIcon: ({ focused }) => (
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: t("homeRoutes.secondbarTitle"),
          tabBarIcon: ({ focused }) => (
            <AntDesign
              name="appstore-o"
              size={24}
      ...
      <Tab.Screen
        ...
        component={Shopping}
        options={{
          tabBarLabel: t("homeRoutes.thirdbarTitle"),
          tabBarIcon: ({ focused }) => (
            <MaterialIcons
              name="storefront"
              size={24}
      ...
      <Tab.Screen
        ...
        component={MyWallet}
        options={{
          tabBarLabel: t("homeRoutes.fourthbarTitle"),
          tabBarIcon: ({ focused }) => (
            <Ionicons
