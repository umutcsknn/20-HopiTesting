      ...
      <View style={styles.cardContainer}>
        <View style={styles.leftOfCard}>
          <Text style={styles.leftCardText}>
            {t("myWalletCards.totalParacikText")}
          </Text>
          ...
          <View style={styles.leftCardBottom}>
            <View style={styles.leftCardBottomInline}>
              ...
              <Text style={styles.leftCardBottomText2}>
                {t("myWalletCards.paracikText")}
              </Text>
            </View>
            <View style={styles.leftCardBottomInline}>
              <Text style={styles.leftCardBottomText3}>3.650,00</Text>
              <Text style={styles.leftCardBottomText4}>
                {t("myWalletCards.giftParacikText")}
              </Text>
            </View>
            <View style={styles.leftCardBottomInline}>
              <Text style={styles.leftCardBottomText5}>0.00</Text>
              <Text style={styles.leftCardBottomText6}>
                {t("myWalletCards.fuelParacikText")}
              </Text>
            </View>
          </View>
        </View>
        <View style={styles.rightOfCard}>
          <View style={styles.circle}>
            ...
            <Text style={styles.rightCardText2}>
              {t("myWalletCards.paracikText")}
            </Text>
          </View>
          <TouchableOpacity>
